...
deploy-sepolia :
	@forge script scripts/DeployRaffle.s.sol:DeployRaffle ${SEPOLIA_RPC_URL} --account "change this to name you used during the cast wallet to encrypt the privatekey without the strings" --broadcast --verify --etherscan-api-key ${ETHERSCAN_API_KEY} -vvvv
